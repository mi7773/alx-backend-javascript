...
describe('CalculateNumber', () => {
  describe('SUM', () => {    
    ...
    it('1 + 3.7 should return 5', () => {
      expect(calculateNumber('SUM', 1, 3.7)).to.deep.equal(5);
    });
    ...
    it('-1.5 + 3.7 should return 3', () => {
      expect(calculateNumber('SUM', -1.5, 3.7)).to.deep.equal(3);
    });

    it('0 + 3.7 should return 4', () => {
      expect(calculateNumber('SUM', 0, 3.7)).to.deep.equal(4);
    });
  });
  ...
  describe('SUBTRACT', () => {    
    ...
    it('-1.5 - 3.7 should return -5', () => {
      expect(calculateNumber('SUBTRACT', -1.5, 3.7)).to.deep.equal(-5);
    });
  ...
  describe('DIVIDE', () => {    
    it('6.2 - 2.9 should return 2', () => {
      expect(calculateNumber('DIVIDE', 6.2, 2.9)).to.deep.equal(2);
    });

    it('1 / 1 should return 1', () => {
      expect(calculateNumber('DIVIDE', 1, 1)).to.deep.equal(1);
    });

    it('3.7 / 2.2 should return 2', () => {
      expect(calculateNumber('DIVIDE', 3.7, 2.2)).to.deep.equal(2);
    });

    it('1.5 / 0 should return "Error"', () => {
      expect(calculateNumber('DIVIDE', 1.5, 0)).to.deep.equal('Error');
    });

    it('-2 / 1 should return -2', () => {
      expect(calculateNumber('DIVIDE', -2, 1)).to.deep.equal(-2);
    });
